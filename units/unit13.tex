...
\begin{figure}[H]
    ...
    \fcolorbox{black}{pink!14}{% רקע צהבהב להבלטת הגורמים המשפיעים
        \includegraphics[width=0.85\textwidth]{figures/CI_impacts.png}
    }
...
\begin{figure}[H]
    ...
    \setlength{\fboxrule}{1pt}  % עובי המסגרת
    \fcolorbox{black}{purple!5}{\includegraphics[width=0.85\textwidth]{figures/typeIerror-power.png}}
...
\begin{figure}[H]
    ...
    \fcolorbox{black}{purple!5}{\includegraphics[width=0.85\textwidth]{figures/typeIIerror-confidence.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/a_b_errors} % השתמשי בתמונה שכבר העלית
